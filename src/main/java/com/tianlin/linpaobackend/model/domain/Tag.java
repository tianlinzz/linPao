...
public class Tag implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getTangName() == null ? other.getTangName() == null : this.getTangName().equals(other.getTangName()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTangName() == null) ? 0 : getTangName().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", tangName=").append(tangName);
